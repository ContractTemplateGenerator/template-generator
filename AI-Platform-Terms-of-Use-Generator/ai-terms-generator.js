...
const AITermsGenerator = () => {
  ...
  const tooltips = {
    ...
    aiOutputOwnership: "Determine who owns content generated by AI - critical for commercial AI platforms",
...
`Any disputes arising from these Terms or your use of the Service will be resolved through binding arbitration administered by the American Arbitration Association (AAA) under its Commercial Arbitration Rules. The arbitration will be conducted in ${formData.jurisdiction}, and the arbitrator's decision will be final and binding. Either party may seek injunctive relief in court for intellectual property disputes or to enforce the arbitration agreement.` : 
          ...
          <div className="form-content">
            ...
            {currentTab === 3 && (
              <div>
                ...
                <div className="form-group">
                  <label>AI Output Ownership <HelpIcon tooltip={tooltips.aiOutputOwnership} /></label>
                  <select
                    name="aiOutputOwnership"
                    value={formData.aiOutputOwnership}
                    onChange={handleChange}
                  >
                    <option value="user">User owns AI output</option>
                    <option value="shared">Shared ownership</option>
                    <option value="platform">Platform retains ownership</option>
                  </select>
                </div>
                
                {/* AI Output Ownership Explanation */}
                <div className="form-explanation">
                  {formData.aiOutputOwnership === 'user' && 
                    'Users own the AI-generated content, providing maximum freedom but potentially reducing your control over how AI output is used.'}
                  {formData.aiOutputOwnership === 'shared' && 
                    'Shared ownership allows both user utilization and platform oversight, balancing user rights with your business interests.'}
                  {formData.aiOutputOwnership === 'platform' && 
                    'Platform ownership provides maximum control but may deter users who want to freely use AI-generated content.'}
                </div>
