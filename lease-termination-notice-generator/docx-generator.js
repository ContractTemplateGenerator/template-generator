// Word Document Generator for Lease Termination Notice
...
<head>
<meta charset="UTF-8">
<title>${formData.documentTitle || "Lease Termination Notice"}</title>
<style>
  body {
...
`;
    ...
    link.download = `${formData.fileName || 'Lease-Termination-Notice'}.doc`;
