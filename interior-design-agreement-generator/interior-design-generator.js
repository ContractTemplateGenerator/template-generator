...
const InteriorDesignAgreementGenerator = () => {
    ...
    const [formData, setFormData] = useState({
        ...
        // Service Type
        serviceType: 'e-design', // 'e-design' or 'full-service'
        eDesignFee: '2000',
...
Date: _______________          Date: _______________`;
    ...
    const createHighlightedText = () => {
        ...
        // Define sections that should be highlighted based on the changed field
        const highlightPatterns = {
            designerName: new RegExp(`(${formData.designerName.replace(/[.*+?^${}()|[\]\\]/g, '\\$&')})`, 'gi'),
            clientName: new RegExp(`(${formData.clientName.replace(/[.*+?^${}()|[\]\\]/g, '\\$&')})`, 'gi'),
            projectAddress: new RegExp(`(${formData.projectAddress.replace(/[.*+?^${}()|[\]\\]/g, '\\$&')})`, 'gi'),
        ...
        return (
            <div className="paywall-overlay">
                <div className="paywall-content">
                    ...
                    <p>Generate a comprehensive, legally-sound interior design services agreement tailored to your business needs.</p>
                    <div className="paywall-price">$14.95</div>
                    <div id="paypal-button-container"></div>
                    <p style={{marginTop: '1rem', fontSize: '0.8rem', color: '#6b7280'}}>
                        One-time payment • Instant access • Save your progress
                    </p>
                </div>
            </div>
        );
                ...
                <div className="form-panel">
                    ...
                    {currentTab === 2 && (
                        <div className="form-section">
                            ...
                            <div className="form-row">
                                <div className="form-group">
                                    <label>Item Removal Fee ($/hour)</label>
                                    <input
                                        type="number"
                                        name="itemRemovalFee"
                        ...
                        <div className="form-section">
                            ...
                            <div className="checkbox-group">
                                <input
                                    ...
                                    onChange={handleChange}
                                />
                                <label>Include rush project surcharge option</label>
                            </div>
                    ...
                    <div className="navigation-buttons">
                        ...
                        >
                            <i data-feather="calendar" style={{marginRight: "0.25rem"}}></i>
                            Consult
                        </button>
