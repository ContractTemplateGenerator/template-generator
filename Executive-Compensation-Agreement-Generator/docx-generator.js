// Document generation utility for Word document export
...
<head>
<meta charset="UTF-8">
<title>${formData.documentTitle || "Executive Compensation Agreement"}</title>
<style>
  body {
...
`;
    ...
    link.download = `${formData.fileName || 'Executive-Compensation-Agreement'}.doc`;
