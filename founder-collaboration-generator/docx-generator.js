// Document generation utility functions
...
<head>
<meta charset="UTF-8">
<title>${formData.documentTitle || "Founder Collaboration Agreement"}</title>
<style>
  body {
...
`;
    ...
    link.download = `${formData.fileName || 'Founder-Collaboration-Agreement'}.doc`;
