// Angel Investor Generator - Complete Version with Date Format Fixes
const AngelInvestorGenerator = () => {
  ...
  // Function to format date to readable format (May 29, 2025)
    ...
    try {
      ...
      if (window.generateWordDoc) {
        window.generateWordDoc(documentText, {
          ...
          signatureDate: formatDateToReadable(formData.signatureDate)
        });
      } else {
          ...
          <div className="tab-content">
            ...
            <div className="finalization-summary">
              ...
              <div className="summary-grid">
                ...
                <div className="summary-item">
                  <strong>Security Type:</strong> {formData.securitiesType.charAt(0).toUpperCase() + formData.securitiesType.slice(1)}
                </div>
                <div className="summary-item">
