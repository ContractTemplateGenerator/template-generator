// Utility functions for MS Word document generation
...
<head>
<meta charset="UTF-8">
<title>${formData.documentTitle || "Membership Pledge & Security Agreement"}</title>
<style>
  body {
...
`;
    ...
    link.download = `${formData.fileName || 'Membership-Pledge-Security-Agreement'}.doc`;
