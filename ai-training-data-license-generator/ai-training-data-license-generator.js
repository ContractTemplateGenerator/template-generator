...
(function() {
  try {
    ...
    console.log("Initializing AI Training Data License Generator...");
    ...
    document.addEventListener('DOMContentLoaded', function() {
      try {
        console.log("DOM loaded, rendering React app...");
    ...
    console.error("Critical error in generator script:", e);
  }
})();