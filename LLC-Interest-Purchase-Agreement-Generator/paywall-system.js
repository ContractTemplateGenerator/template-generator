// PayPal Paywall System for LLC Interest Purchase Agreement Generator
// Integrates with existing generator to require payment before copy/download access

const PaywallSystem = (() => {
    // PayPal Configuration - Updated for LLC generator
    const PAYPAL_CONFIG = {
        ...
        currency: 'USD',
        amount: '14.95', // Price for LLC Interest Purchase Agreement Generator
        description: 'LLC Interest Purchase Agreement Generator - Professional Legal Document'
    };

    // Persistent payment status tracking using localStorage
    const getPaymentStatus = () => {
        try {
            const stored = localStorage.getItem('llcGeneratorPaymentStatus');
            if (stored) {
    ...
    const savePaymentStatus = (status) => {
        try {
            localStorage.setItem('llcGeneratorPaymentStatus', JSON.stringify(status));
        } catch (e) {
                ...
                <div class="paywall-modal">
                    ...
                    <div class="paywall-content">
                        <div class="paywall-features">
                            <h3>What You Get:</h3>
                            <ul>
                                <li>✅ Professional LLC Interest Purchase Agreement</li>
                                <li>✅ Customizable for any LLC structure</li>
                                <li>✅ Comprehensive representations & warranties</li>
                                <li>✅ Payment options (full, deposit, installments)</li>
                                <li>✅ Copy to clipboard functionality</li>
                                <li>✅ Download as MS Word document</li>
                                <li>✅ Attorney-drafted template</li>
    ...
    const validateManualPayPalId = () => {
        ...
        if (paypalId.length === 17 && 
            ...
            alert('Access unlocked! You can now copy and download your LLC Interest Purchase Agreement.');
